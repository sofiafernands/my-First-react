...
function Nav () {
    return( <nav className="navbar navbar-expand-lg bg-body-tertiary w-500px" style={{ backgroundColor: "#4E5050"}}>
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{paddingLeft:"80%",marginRight:"100px"}}>
